...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            field=models.CharField(
                ...
                validators=[
                    django.core.validators.RegexValidator(
                        "^\\w+:[a-z0-9A-Z_]+$", "Page code must be ^\\w+:[a-z0-9A-Z_]+$"
                    )
                ],
        ...
        migrations.AlterField(
            ...
            name="code",
            field=models.CharField(
                db_index=True, max_length=30, unique=True, verbose_name="Tag ID"
            ),
        ),
        migrations.AlterField(
            model_name="tag",
            name="name",
            field=models.CharField(
                db_index=True, max_length=100, verbose_name="Tag name"
            ),
        ),
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                validators=[
                    django.core.validators.RegexValidator(
                        "^[a-zA-Z0-9_]+$", "Problem code must be ^[a-zA-Z0-9_]+$"
                    )
                ],
