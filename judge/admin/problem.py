...
class ProblemForm(ModelForm):
    ...
    class Meta:
        widgets = {
            ...
            "suggester": AdminHeavySelect2Widget(
                data_view="profile_select2", attrs={"style": "width: 100%"}
            ),
...
class ProblemAdmin(NoBatchDeleteMixin, VersionAdmin):
    ...
    make_public_and_update_publish_date.short_description = _(
        "Mark problems as public and set publish date to now"
    )
    ...
    def save_model(self, request, obj, form, change):
        ...
        if form.changed_data and any(
            ...
            for f in ("is_public", "is_organization_private", "partial")
        ):
